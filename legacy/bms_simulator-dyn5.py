...
# --- SZENARIEN ---
# drift_pct: wie stark Werte prozentual schwanken (0.10 = +/-10%)
# current_wave: [amplitude, offset, period_s] fuer Sinus-Strom
SCENARIOS = {
    "normal": {
        "desc": "Normalbetrieb mit Drift (+/-10%)",
        "cell_v": 3.28, "cell_spread": 0.008,
        "temps": [25.0, 24.5, 25.2, 24.8, 28.0, 22.0, 26.0],
        "current_wave": [3.0, 0.0, 60],
        "soc_pct": 65, "soh": 100, "full_ah": 30.0,
        "drift_pct": 0.10,
    },
    "charge": {
        "desc": "Laden, schwankend 10-20A",
        "cell_v": 3.35, "cell_spread": 0.008,
    ...
    "full": {
        "desc": "Voll geladen (100%)",
        "cell_v": 3.45, "cell_spread": 0.002,
        "temps": [26.0, 25.5, 26.5, 25.0, 28.0, 22.0, 27.0],
        "current_wave": [0.3, 0.2, 90],
        "soc_pct": 100, "soh": 100, "full_ah": 30.0,
        "drift_pct": 0.02,
    },
}
